...
namespace Backend.RazorModels
{
    ...
    public class HoluserRazorModel
    {
        #region Constructor
        ...
        public HoluserAdapterModel CurrentRecord { get; set; } = new HoluserAdapterModel();
        public HoluserAdapterModel CurrentNeedDeleteRecord { get; set; } = new HoluserAdapterModel();
        ...
        private readonly IHoluserService CurrentService;
        ...
        public void ToolbarClickHandler(Syncfusion.Blazor.Navigations.ClickEventArgs args)
        {
            ...
            {
                CurrentRecord = new HoluserAdapterModel();
        ...
        public void OnCommandClicked(CommandClickEventArgs<HoluserAdapterModel> args)
        {
            HoluserAdapterModel item = args.RowData as HoluserAdapterModel;
